...
$db=mysql_select_db("invqc", $con)or die("Gagal Koneksi");
...
<table width="100%" border="0" class="table-list1" style="width:7.8in;">
  <tbody>
    <tr style="height:0.25in;">
      ...
      <td colspan="2"><?php if($d[dept]!=""){ echo $d[dept]." (".$d[sub_dept].")";}?></td>
      <td width="18%" align="center" valign="middle">Tgl. PERMOHONAN</td>
      <td colspan="2"><?php echo $d[tglmohon];?></td>
    </tr>
    <tr style="height:0.25in;">
...
<table width="100%" border="0" class="table-list1" style="width:7.8in;">
  <tbody>
    ...
    <tr style="height:0.7in;">
      <td align="left" valign="top"><?php echo $d[note];?></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
